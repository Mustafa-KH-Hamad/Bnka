...
<div class="flex flex-col items-center min-h-max p-6">
    ...
    <!-- Location Information with a Link -->
    ...
    <div class="flex space-x-6 mb-4">
        <!-- Facebook Icon -->
        <a href="#" target="_blank" class="text-blue-600 hover:text-blue-800 flex items-center space-x-2">
